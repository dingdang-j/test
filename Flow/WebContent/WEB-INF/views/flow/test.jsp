	...
	<div id="flow-panel">
		<table>
			<tr>
				...
				<td rowspan="2">
					<div class="wait-user"><span class="panel-font">未操作者</span></div>
					<div class="pass-user"><span class="panel-font">已操作者</span></div>
					<div class="stop-user"><span class="panel-font">已查看者</span></div>
				</td>
			</tr><tr>
